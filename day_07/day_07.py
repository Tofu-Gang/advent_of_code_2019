...
AMPLIFIERS_COUNT = 5
PHASE_SETTINGS = list(permutations(range(AMPLIFIERS_COUNT)))
PHASE_SETTINGS_FEEDBACK_LOOP = list(permutations(
    range(5, 5 + AMPLIFIERS_COUNT)))
INPUT_SIGNAL = 0
...
def puzzle_1() -> None:
    ...
    The answer should be 14902.
    """

    with open("day_07/input.txt", 'r') as f:
        max_output_signal = -maxsize - 1
        program = tuple([
